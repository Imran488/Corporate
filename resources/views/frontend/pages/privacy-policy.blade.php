...
<section id="contact" class="contact">
    <div class="container">
        ...
        <div class="php-email-form">
            <p>Your privacy is important to us. It is Maxibobd Int Ltd's policy to respect your privacy and comply with any
                applicable law and regulation regarding any personal information we may collect about you, including
                across our website, https://www.maxibobd.com, and other sites we own and operate. </p>
            ...
            <p>In the event our site contains links to third-party sites and services, please be aware that those
                sites
                and services have their own privacy policies. After following a link to any third-party content, you
                should read their posted privacy policy information about how they collect and use personal
                information.
                This Privacy Policy does not apply to any of your activities after you leave our site. </p>
            <p>This policy is effective as of:
                <?php
                $dt = strtotime("2022-12-24");
                echo date("Y-m-d", strtotime("+1 month", $dt))."\n";
                ?>
            </p>
            <p>Last updated:
                <?php
                $dt = strtotime("2021-12-24");
                echo date("Y-m-d", strtotime("+1 month", $dt))."\n";
                ?>
            </p>
            <h3 style="color:#37517e">What Information We Collect</h3>
            <p>Information we collect falls into one of two categories: One is “voluntarily provided” information
                and
                another one is “automatically collected” information. </p>
            <p>“Voluntarily provided” information refers to any information you knowingly and actively provide us
                when
                using or participating in any of our services and promotions. </p>
            <p>“Automatically collected” information refers to any information automatically sent by your devices in
                the
                course of accessing our products and services. </p>
            <h3 style="color:#37517e">Collection and Use of Information</h3>
            ...
            <h3 style="color:#37517e">Security of Your Personal Information</h3>
            ...
            <p>You are responsible for selecting any password and its overall security strength, ensuring the
                security
                of your own information within the bounds of our services. For example, ensuring you do not make
                your
                personal information publicly available via our platform. </p>
            <h3 style="color:#37517e">How Long We Keep Your Personal Information</h3>
            <p>We keep your personal information only for as long as we need to. This time period may depend on what
                ...
                enquiry, we may retain this information for the duration of your enquiry remaining open as well as
                for
                our own records so we may effectively address similar enquiries in future. If your personal
                information
            ...
            <h3 style="color:#37517e">Children’s Privacy</h3>
            ...
            <h3 style="color:#37517e">Your Rights and Controlling Your Personal Information</h3>
            <p><span>Your choice:</span> By providing personal information to us, you understand we will collect,
                hold,
                use, and disclose your personal information in accordance with this privacy policy. You do not have
                to
                provide personal information to us, however, if you do not, it may affect your use of our website or
                the
                products and/or services offered on or through it. </p>
            <p><span>Information from third parties:</span> If we receive personal information about you from a
                third
            ...
            <p><span>Marketing permission:</span> If you have previously agreed to us using your personal
                information
                for direct marketing purposes, you may change your mind at any time by contacting us using the
                details
                below. </p>
            ...
            <p><span>Non-discrimination:</span> We will not discriminate against you for exercising any of your
                rights
                over your personal information. Unless your personal information is required to provide you with a
                particular service or offer (for example providing user support), we will not deny you goods or
                services
                and/or charge you different prices or rates for goods or services, including through granting
                discounts
                or other benefits, or imposing penalties, or provide you with a different level or quality of goods
                or
                services. </p>
            <p><span>Notification of data breaches:</span> We will comply with laws applicable to us in respect of
                any
                data breach. </p>
            <p><span>Complaints: </span>If you believe that we have breached a relevant data protection law and wish
                to
                make a complaint, please contact us using the details below and provide us with full details of the
                alleged breach. We will promptly investigate your complaint and respond to you, in writing, setting
                out
                the outcome of our investigation and the steps we will take to deal with your complaint. You also
                have
                the right to contact a regulatory body or data protection authority in relation to your complaint.
            </p>
            <p><span>Unsubscribe:</span> To unsubscribe from our email database or opt-out of communications
                (including
            ...
            <h3 style="color:#37517e">Use of Cookies</h3>
            ...
            <h3 style="color:#37517e">Business Transfers</h3>
            ...
            <h3 style="color:#37517e">Limits of Our Policy</h3>
            ...
            <h3 style="color:#37517e">Changes to This Policy</h3>
            ...
            <h3 style="color:#37517e">Contact Us</h3>
            <p>For any questions or concerns regarding your privacy, you may contact us using the following details:
            </p>
            <h3 style="color:#37517e">Maxibobd Int Ltd</h3>
            <p>
                House- 07, Suite- 2A, <br>
                Road- 14/C, Sector- 04, Uttara 1230,<br>
                Dhaka Division, Bangladesh <br>
                <strong>Phone:</strong> 01680-329598<br>
                <strong>Email:</strong> info@maxibobd.com<br>
            </p>
        </div>
    </div>
</section>
